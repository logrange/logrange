...
func TestQueryRequest(t *testing.T) {
	...
	testQueryRequest(t, &api.QueryRequest{ReqId: 123412349182374, Tags: "a=b|c=d", Where: "adfasdfdsf", Pos: "ddd", Limit: 1234})
}

func TestQueryResult(t *testing.T) {
	testQueryResult(t, &api.QueryResult{})
	testQueryResult(t, &api.QueryResult{NextQueryRequest: api.QueryRequest{ReqId: 123412349182374, Tags: "a=b|c=d", Where: "adfasdfdsf", Pos: "ddd", Limit: 1234},
		Events: []*api.LogEvent{
			&api.LogEvent{1, "mes1", ""},
...
func TestQueryResultBuilder(t *testing.T) {
	...
	qb.writeQueryRequest(&api.QueryRequest{ReqId: 123412349182374, Tags: "a=b|c=d", Where: "adfasdfdsf", Pos: "ddd", Limit: 1234})
	var rqr api.QueryResult
	unmarshalQueryResult(qb.buf(), &rqr, true)
	qb.Close()

	tqr := &api.QueryResult{NextQueryRequest: api.QueryRequest{ReqId: 123412349182374, Tags: "a=b|c=d", Where: "adfasdfdsf", Pos: "ddd", Limit: 1234},
		Events: []*api.LogEvent{
			&api.LogEvent{1, "mes1", ""},
